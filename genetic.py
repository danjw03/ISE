...
def mutate_individual(individual, sensitive_columns, non_sensitive_columns, X_test, mutation_prob=0.1):
    sample_a, sample_b = individual
...
def genetic_algorithm(model, X_test, sensitive_columns, non_sensitive_columns, pop_size=100, generations=50, tournament_size=3, crossover_prob=0.8, mutation_prob=0.1, threshold=0.05):
    ...
    for gen in range(generations):
        ...
        while len(new_population) < pop_size:
            ...
            # Mutation
            child = mutate_individual(child, sensitive_columns, non_sensitive_columns, X_test, mutation_prob)
...
def run_fairness_testing(dataset_name):
    ...
    best_ind, best_fit, ga_idi_ratio = genetic_algorithm(
        ...
        mutation_prob=0.3, threshold=0.05
    )
